...
export default function ChatInput({ placeholder, onSend, onTyping, onStopTyping, disabled, members = [] }: ChatInputProps) {
  ...
  return (
    <div className="bg-white dark:bg-slate-800 border-t border-slate-200 dark:border-slate-700 p-2 sm:p-4 shrink-0">
      <div className="bg-slate-50 dark:bg-slate-700 rounded-lg border border-slate-200 dark:border-slate-600 focus-within:border-indigo-500 focus-within:ring-2 focus-within:ring-indigo-500/20 transition-all">
        ...
        <div className="flex items-end gap-2 px-2 py-1.5 sm:px-3 sm:py-2">
          <textarea
            ...
            className="flex-1 px-2 py-1.5 bg-transparent border-0 text-sm text-slate-900 dark:text-white placeholder:text-slate-400 dark:placeholder:text-slate-500 focus:outline-none resize-none leading-5"
            rows={1}
